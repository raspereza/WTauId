...
void PlotWTauNu(TString iso = "MediumMva") {
  ...
  TString         cutsTauId("tauDM>0.5&&tauAntiMuonLoose3>0.5&&tauAntiElectronLooseMVA6>0.5&&tau"+iso+"Iso>0.5");
  TString cutsInverseTauIso("tauDM>0.5&&tauAntiMuonLoose3>0.5&&tauAntiElectronLooseMVA6>0.5&&tau"+iso+"Iso<0.5");
  ...
  TString sampleNames[30] = {
    ...
    "ST_t-channel_top_4f_leptonDecays_13TeV-powheg",     // t-channel_top     (14)
    "ST_t-channel_antitop_4f_leptonDecays_13TeV-powheg", // t-channel_antitop (15)
  ...
  cuts[1] = "fakeAntiL"+iso+"*("+cutsTrigger+CutsBkg+"&&metFilters)";
  cuts[2] = "fakeAntiL"+iso+"Up1*("+cutsTrigger+CutsBkg+"&&metFilters)";
  cuts[3] = "fakeAntiL"+iso+"Up2*("+cutsTrigger+CutsBkg+"&&metFilters)";
  cuts[4] = "fakeAntiL"+iso+"Up3*("+cutsTrigger+CutsBkg+"&&metFilters)";
  ...
  // Creating inputs
  // *************** 
  TString BaseName = Variable+"_"+iso+"Iso_WTauNu";
  ...
  canv1->Update();
  canv1->Print("figures/"+Variable+"_"+iso+"Iso_WTauNu.png");
  std::cout << std::endl;
